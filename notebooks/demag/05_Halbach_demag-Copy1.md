...
def create_meshed_Halbach(
    ...
    **halbach_params,
    ...
    for src in hc_meshed.sources_all:
        src.xi = 0.05
    ...
    for src in shield_meshed.sources_all:
        src.xi = 3999
...
```{raw-cell}
hc = HalbachCylinder()
from magpylib_extras.sensor import Streamlines
from magpylib_extras import display_system

sl = Streamlines(position=(0,0,20), Nelem=(20,20), dimension=(80,80))
fig = go.Figure(layout_height=600)
display_system(hc, sl, canvas=fig)
fig
```
